package com.chatchai.project.ResideMenu;
...
public class ResideMenu extends FrameLayout {
    ...
    /**
     ตรงนี้กูโมเอง เอาไว้สำหรับเช็คตอนนที่เลื่อนหน้าจอจากทางซ้าย
     */

    private void CheckScreen(int direction) {
